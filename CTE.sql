...
--Am�rique du nord check/default
ALTER TABLE tblJoueursAmeriqueNord
...
PRINT('Check "codeZone" plus grand ou �gal a 0 et plus petit ou egal a 6 dans "tblZoneGeographique".')
GO
...
PRINT('Check "codeZone" plus grand ou �gal a 50 000 dans "tblTournoi".')
GO
